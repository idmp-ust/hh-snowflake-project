...
CREATE OR REPLACE DYNAMIC TABLE SILVER_DB.ECASE_RAC_DT_ASSESSMENT_COMPOUNDING_FACTORS_CONFORMED
...
SELECT
    ...
    CASE
        WHEN L.Name = 'Compounding Factors'
         AND L.Text = 'Do I have any compounding factors? ::: Yes ### No'
         AND L.SelectionValue = 0 THEN 'Yes'
        WHEN L.Name = 'Compounding Factors'
         AND L.Text = 'Do I have any compounding factors? ::: Yes ### No'
...
WHERE L.Name = 'Compounding Factors'
